...
const Card = React.forwardRef<HTMLElement, React.HTMLAttributes<HTMLElement>>(({ className, ...props }, ref) => (
  <section ref={ref as React.RefObject<HTMLElement>} className={cn("rounded-2xl border border-border/80 bg-card text-card-foreground shadow-[0_10px_32px_rgba(31,48,78,0.05)]", className)} {...props} />
));
