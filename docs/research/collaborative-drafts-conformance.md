...
The next sharp decision is [#16, semantic graph collaboration and lossless authoring round trips](https://github.com/09millarda/agents-assemble/issues/16), dependent on #12. The flat fixture cannot decide nested shared-field representation, concurrent parent/move semantics, bindings/scopes, complete grammar validation or visual/JSON/TypeScript preservation. That work remains a disposable decision experiment rather than a production editor implementation slice.
