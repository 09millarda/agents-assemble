...
The following bounded decisions were graduated from #4 as native sub-issues of map #1. #12 is resolved by ADR 0007, #16 by ADR 0008, #13 by ADR 0009 and #14 by ADR 0010; #15 is claimed and awaits an identified disposable AWS environment. #14 graduates portable envelope/verifier decision #17. These are not implementation tickets.
...
| [#15 — Lambda deployment identity and recovery](https://github.com/09millarda/agents-assemble/issues/15) | [Experiment plan](research/lambda-deployment-plan.md) and [source comparison](research/lambda-deployment-sources.md) prepared; sandbox/account/region/authentication and dedicated fixture repository remain to identify. All real dispatch, staging-to-production promotion and health/rollback cases remain unexercised. |
